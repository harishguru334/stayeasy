    ...
    <div className="flex h-[100vh]">
      ...
      <div className="sm:flex-1 min-w-[100%] md:min-w-[80%] overflow-scroll">
        ...
        <div className=" w-[100%] p-6 sm:w-250">
          ...
          {/* Tabs */}
          <div className="flex w-[100%] sm:w-100 gap-2 sm:mb-4">
            {tabs.map(t => (
          ...
          <div className="bg-white  rounded-b shadow">
              ...
              <form onSubmit={saveCheckIn} className="sm:grid sm:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className=''>
                    ...
                    <input placeholder="WiFi User Name" value={form.wifiUser} onChange={e => updateField('wifiUser', e.target.value)} className=" border sm:pl-4 sm:pr-28 py-2 rounded mt-[0px] mb-4 " />
                    <input placeholder="WiFi Password" value={form.wifiPass} onChange={e => updateField('wifiPass', e.target.value)} className=" border sm:pl-4 sm:pr-28 ml-32 sm:ml-0 py-2 rounded mt-[21px]" />
                  </div>
                </div>
            ...
            <div className=" sm:flex sm:justify-end-safe gap-3">
              <button type="button" onClick={() => { navigator.clipboard?.writeText(JSON.stringify({ form, guestPhotos, extraPersons, posting, gst: isGST ? gstNumber : null })); alert('Copied payload to clipboard (for testing)') }} className="px-6 mr-12 mt-4 py-2 border rounded">Copy Payload</button>
              <button onClick={saveCheckIn} className="px-6 py-2 mt-4 bg-blue-600 text-white rounded">Save Check-In</button>
            </div>
